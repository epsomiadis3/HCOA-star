...
import torch
import random
from HCOAStar.dsg_processor.dsg_loader import convert_dsg_subway
...
if __name__ == "__main__":
    ...
    convert_dsg_subway(path_to_dsg = ROOT_PATH / data["dsg_json_path"], output_file = ROOT_PATH / data["graph_info_path"])
